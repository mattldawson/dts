...
docker image tag dts:$TAG registry.nersc.gov/kbase/dts:$TAG
...
docker login -u $USERNAME https://registry.nersc.gov/
docker image push registry.nersc.gov/kbase/dts:$TAG
docker logout https://registry.nersc.gov/
